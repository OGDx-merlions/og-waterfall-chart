...
function runBaseTests() {
  og_waterfall_chart_1 = document.getElementById('og_waterfall_chart_1');

  suite('Base Automation Tests for og-waterfall-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-waterfall-chart fixture is created', function() {
      assert.isTrue(document.getElementById('og_waterfall_chart_1') !== null);
    });
